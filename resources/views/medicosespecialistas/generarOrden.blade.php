        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    {{ __('Generar Orden') }}
                    <button type="button" onclick="window.location='/medicosEspecialistas/agenda'" class="btn btn-outline-primary float-right">Cancelar</button>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('medicosEspecialistas.storeOrden') }}">
                        @csrf
