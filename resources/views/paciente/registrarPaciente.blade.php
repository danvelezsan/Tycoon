                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cedula" type="number" class="form-control @error('cedula') is-invalid @enderror" name="cedula" value="{{ old('name') }}" required autocomplete="cedula" autofocus min="0" placeholder="Ingrese su cédula">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" value="{{ old('nombre') }}" required autocomplete="nombre" placeholder="Ingrese su nombre completo">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="apellidos" type="text" class="form-control @error('apellidos') is-invalid @enderror" name="apellidos" required autocomplete="apellidos" placeholder="Ingrese sus apellidos">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fechaNac" type="date" class="form-control @error('fechaNac') is-invalid @enderror" name="fechaNac" required autocomplete="fechaNac" placeholder="Ingrese la fecha de nacimiento">
